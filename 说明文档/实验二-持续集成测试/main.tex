...
运行页为 \url{https://github.com/diydashi/campus-weather-lab/actions/runs/32258964845}。提交课程报告时可截取该页的绿色作业和 Artifacts 区域；机器可读摘要另存于 \path{reports/experiment-2/github-run-32258964845/}。GitHub 官方 Python CI 教程给出了使用 \code{setup-python}、pytest、构建和制品上传的典型方式\cite{github-python-ci}。
